...
17. Manifest-declared macro provider metadata and runtime exports must stay aligned. Generated runners should prove the actual `module_path` and macro-name surface before expansion runs.
