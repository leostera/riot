...
14. Prefer explicit compilation-unit stages over one-off planner hooks when adding source-processing steps. Macro expansion should live in a narrow pipeline stage that lowers cleanly into action-graph writes and compile actions.
